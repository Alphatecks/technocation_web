...
import { Achievements, MainLayout, ProgressBar, ThumbSlider } from '../../../../containers'
                ...
                <div className="statistics-page">
                    <main>
                        ...
                        <div className="row mp">
                            <div className="col-3">
                                <div className="col-3_img light-purple-bg ">
                                    <div className="icon purple-text"> <FaBookOpen/> </div>
                                </div>
                            ...
                            <div className="col-3">
                                <div className="col-3_img light-green-bg ">
                                    <div className="icon green-text"> <FaCheckDouble/> </div>
                                </div>
